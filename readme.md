...
### Rule-based Approach
The rule-based approach uses the lines found in the PDF for the table detection. All lines are extracted with [pdfplumber](https://github.com/jsvine/pdfplumber) and vertical lines are ignored.
...
Starting with this bbox, the process is repeated until the bounding box does not change anymore. <br>
...
The rotation is important, as the following image shows. The most right character would be one of the characters inside the black box. This would lead to a table with an additional column and incorrect rows. <br>
...
| <img src="assets/remove_at_bottom.png" width="570" /> | <img src="assets/remove_footnote.png" width="630" /> |
|:--:|:--:|
...
A font change below this line isn't considered. This means that for bigger tables, the font change has to be in a higher part of the table than for smaller tables. 
...
| <img src="assets/font_criteria.png" width="550" /> | <img src="assets/font_criteria_exception.png" width="650" /> |
|:--:|:--:|
| *Separate column when the font changes* | *A minimum threshold is still important* |

### Currency & Special Symbols
To comply with the fintabnet dataset, currency symbols are not in an extra column. This is sometimes the case when the character spacing is too big. To overcome this issue, between currency symbols and other characters, no column separator is added. Instead, when a currency column is detected, before the currency symbol, a column separator is inserted. 

There is also a counterpart for symbols, that normally come after a number, such as a percent sign. Between a number and a symbol, no column is inserted, but instead after it.

Other special symbols, that are completely ignored for the column detection, are spaces, dots, line breaks and tabs. <br>
The minus is special, because not only before, but also after it, no column is created. Numbers are sometimes given in ranges, so this prevents a column split in these cases.

| <img src="assets/problem_layout_percent.png" width="550" /> | <img src="assets/special_minus.png" width="350" /> |
|:--:|:--:|
| *Columns cannot be detected because a the percent sign* | *Minus sign as special symbol* |
...
| <img src="assets/fintab_false_annotated.png" width="350" /> | <img src="assets/fintab_false_annotated2.png" width="400" /> | <img src="assets/fintab_false_cells.png" width="500" /> |
|:--:|:--:|:--:|
...
| <img src="assets/problem_table_bottom_threshold.png" width="550" /> | <img src="assets/problem_not_a_table.png" width="650" /> |
|:--:|:--:|
...
## Layout detection
| <img src="assets/problem_header_detection.png" width="630" /> | <img src="assets/problem_footnote_separation.png" width="570" /> |
|:--:|:--:|
